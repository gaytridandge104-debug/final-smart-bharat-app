function Hero() {
  return (
    <section className="bg-blue-50 pt-16 pb-24 px-6">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-6">
            <div className="flex-1 flex items-center bg-white border border-blue-200 rounded-full px-4 py-3">
              ...
              />
              <a href="#ai-assistant" className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-4 py-2 rounded-full flex items-center gap-1 ml-2">
                ➤ Ask AI
              </a>
            </div>
          </div>
